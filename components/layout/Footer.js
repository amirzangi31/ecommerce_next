  ...
  return (
    <footer className="footer">
      <div className="container mx-auto px-2">
        <div className="footer__content-up">
          <Zoom>
            <div className="">
              <h3 className="py-2 text-text-primary text-2xl">ماتریکس(لگو)</h3>
          ...
          <Zoom>
            <div className="footer__menu">
              <h5 className="text-xl text-center text-text-primary">منو</h5>
          ...
          <Zoom>
            <div className="">
              <h5 className="text-xl text-center text-text-primary">
                عضویت در خبرنامه ما{" "}
              </h5>
              <p className="my-2">
                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با
              ...
              <div className="bg-text-secondary p-2 rounded-lg border border-text-primary">
                <input
                  type="text"
        ...
        <div className="border-t border-white py-2">
          <p className="text-xs text-center text-text-primary">
            تمامی حقوق مادی و معنوی این سایت برای <span className="text-bg-primary font-bold text-sm underline underline-offset-2">امیرمحمد زنگی ابادی</span> میباشد
          </p>
        </div>
      </div>
    </footer>
